...
'admin/clients/view/{id}/advisors',
'admin/clients/view/{id}/advisor/{advisorId}',
...
'admin/departments/associations',
'admin/departments/associations/create',
'admin/departments/associations/edit/{id}',
...
'admin/examples',
'admin/examples/livewire',
'admin/examples/livewire/table',
'admin/examples/inertia',
'admin/examples/forms',
'admin/examples/forms/layouts',
'admin/examples/tables',
'admin/activity_log',
