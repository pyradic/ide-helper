...
'admin/clients/caretaker/intake/{clientId}/view',
'admin/clients/caretaker/intake/{clientId}/create',
'admin/clients/caretaker/intake/{clientId}/edit',
'admin/clients/registrations/{client}/{clientRole}',
'admin/clients/registrations/{client}/create/{clientRole}',
'admin/clients/registrations/edit/{id}',
'admin/clients/registrations/view/{id}',
'admin/clients/registrations/subject_field/{categoryId}/{id?}',
'admin/clients/registrations/reports/{client}/{clientRole}',
'admin/clients/registrations/reports/{client}/create/{clientRole}',
'admin/clients/registrations/reports/edit/{id}',
'admin/clients/registrations/reports/view/{id}',
'admin/clients/registrations/reports/subject_field/{categoryId}/{id?}',
'admin/clients/registrations/subjects',
'admin/clients/registrations/subjects/create',
'admin/clients/registrations/subjects/edit/{id}',
'admin/clients/registrations/categories',
'admin/clients/registrations/categories/create',
'admin/clients/registrations/categories/edit/{id}',
...
'admin/clients/requester/{client}',
...
'admin/clients/requester/intake/groups/edit/{requesterGroup}',
'admin/clients/requester/requests',
'admin/clients/requester/requests/{client}',
'admin/clients/requester/requests/create/{client}',
'admin/clients/requester/requests/edit/{client}',
'admin/clients/requester/requests/view/{client}',
'admin/clients/requester/requests/close/{id}',
'admin/clients/requester/requests/open/{id}',
'admin/clients/requester/requests/categories',
'admin/clients/requester/requests/categories/create',
'admin/clients/requester/requests/categories/edit/{id}',
'admin/activity_log',
