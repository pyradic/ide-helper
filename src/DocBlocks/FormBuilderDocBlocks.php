...
class FormBuilderDocBlocks
{
    ...
    public function handle(DocRegistry $registry)
    {
        ...
        $cd->getMethod('addField')
            ->ensureParam('$field', 'string|array', '= \\' . FormBuilderExamples::class . '::field()')
            ->ensureParam('$definition', 'array', '= \\' . FormBuilderExamples::class . '::field()');
        $cd->getMethod('addField')->ensureParam('$fields', 'array', '= \\' . FormBuilderExamples::class . '::fields()');
